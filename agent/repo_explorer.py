...
def explore(repo_path: str) -> list[str]:
    """
    Lista recursivamente todos los archivos .py, .js y .ts de un repositorio.

    Args:
        repo_path: Ruta al directorio raíz del repositorio.

    Returns:
        Lista ordenada de rutas relativas al repo_path para cada archivo
        soportado, ignorando directorios en IGNORED_DIRS y sus subdirectorios.
